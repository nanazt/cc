...
- [x] **VRFY-03**: Verifier produces no false positives on non-service projects
...
- [x] **CASE-03**: /case produces PR/TR-classified rules (permanent vs temporary)
- [x] **CASE-04**: CASES.md includes Superseded Operations table when applicable
- [x] **CASE-05**: CASES.md includes Superseded Rules table when applicable
- [x] **CASE-06**: Rules use OR-N prefix natively
- [x] **CASE-07**: case-validator accepts TR-N, OR-N and recognizes supersession sections
- [x] **CASE-08**: case-briefer reads `specs/{unit}/cases.md` first, falling back to phase directories only when spec does not exist
...
| CASE-03 | Phase 12 | Complete |
| CASE-04 | Phase 12 | Complete |
| CASE-05 | Phase 12 | Complete |
